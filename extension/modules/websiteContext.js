const KNOWN_SITES = {
  ...
  'instagram.com': { brand: 'Instagram', keywords: ['Photo', 'Story', 'Social', 'Creative'] },
  'twitter.com':   { brand: 'X',         keywords: ['Post', 'Media', 'Social', 'Trend'] },
  'x.com':         { brand: 'X',         keywords: ['Post', 'Media', 'Social', 'Trend'] },
  'reddit.com':    { brand: 'Reddit',    keywords: ['Forum', 'Community', 'Post', 'Vote'] },
  'discord.com':   { brand: 'Discord',   keywords: ['Chat', 'Server', 'Voice', 'Community'] },
  'twitch.tv':     { brand: 'Twitch',    keywords: ['Stream', 'Gaming', 'Channel', 'Live'] },
  'spotify.com':   { brand: 'Spotify',   keywords: ['Music', 'Playlist', 'Stream', 'Audio'] },
  'adobe.com':     { brand: 'Adobe',     keywords: ['Creative', 'Design', 'Cloud', 'Photo'] },
  'dropbox.com':   { brand: 'Dropbox',   keywords: ['Cloud', 'Storage', 'File', 'Sync'] },
  'slack.com':     { brand: 'Slack',     keywords: ['Team', 'Chat', 'Work', 'Channel'] },
  'notion.so':     { brand: 'Notion',    keywords: ['Note', 'Page', 'Workspace', 'Block'] },
  'figma.com':     { brand: 'Figma',     keywords: ['Design', 'Prototype', 'Creative', 'Vector'] },
};
