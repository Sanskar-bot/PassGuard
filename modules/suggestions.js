...
export function generateSuggestions(strength, wordlist, patterns, username, scoreResult) {
  ...
  if (patterns.keyboard.found) {
    tips.push({ priority: "high", icon: "⌨️",
  ...
  if (scoreResult.score < 75) {
    tips.push({ priority: "low", icon: "💡",
      text: "Tip: Use a passphrase — four random words joined together are both memorable and strong (e.g. 'coffee-orbit-maple-7')." });
  }
